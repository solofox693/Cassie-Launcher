...
Guide for writing **C#** plugins for the Cassie Clip Launcher using the `IFnPlugin` SDK. See the `ExamplePlugin` folder for a full working sample.
...
1. Copy your built `.dll` into:
   ...
   ```
2. Restart the launcher — your plugin should appear in the plugin list.
