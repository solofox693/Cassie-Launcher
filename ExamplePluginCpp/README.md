...
Guide for writing native **C++/CLI** plugins for the Cassie Clip Launcher using the `IFnPlugin` SDK. See the `HelloWorldCpp` example folder for a full working sample.
...
3. Restart the launcher — your plugin should appear in the plugin list.
