...
Guide for writing native **C++/CLI** plugins for the Cassie Clip Launcher using the `IFnPlugin` SDK. See the `ExamplePLuginC++` example folder for a full working sample.
